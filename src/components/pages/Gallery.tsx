  ...
  return (
    <>
      <PageLayout>
        ...
        />
        <main className="">
          <p className="text-slate-800 dark:text-white text-[1.4rem] lg:text-[1.2rem] sm:text-[1rem]
           font-RalewayBold w-[65%] lg:w-[90%] sm:w-[98%] sm:px-2 mx-auto ">
            <span className="text-red-800 dark:text-orange-500 text-[1.7rem] lg:text-[1.4rem] 
          ...
          >
            <div className="grid grid-cols-4 px-36 xl:px-24 lg:px-8 md:px-20 sm:px-12 gap-x-10 xl:gap-x-6 
