...
const TailwindForm = () => {
  return (
    <div className=" mx-auto mt-5 z-[1200] pb-16  ">
      <form
        className="bg-black/10 rounded-3xl p-10 w-[60%] xl:w-[50%] md:w-[85%] mx-auto z-[100] font-Raleway
      border-[1px] border-gray-500 dark:border-yellow-300 shadow-[0px_0px_40px_-10px_green] dark:shadow-[0px_0px_40px_-10px_gray] text-gray-300 "
      >
        <div className="space-y-8">
          <div className="border-b border-gray-900/10">
            <p className="block mt-1 text-sm leading-6 text-gray-800 dark:text-gray-200 ">
              This information will be displayed publicly so be careful what you
              share.
            </p>
          </div>
          <div className="border-b border-gray-900/10 pb-1">
            <h2 className="block text-base font-semibold leading-7 text-gray-800 dark:text-gray-200">
            ...
            <div className="mt-5 grid grid-cols-2 mx-auto gap-x-10 gap-y-5 w-[75%] lg:w-[85%] ">
              <div className="col-span-full">
                <label
                  htmlFor="first-name"
                  className="block text-left text-sm font-medium leading-6 text-gray-800 dark:text-gray-200"
                >
                  Full name:
                </label>
                <div>
              ...
              <div className="col-span-full">
                <label
                  htmlFor="email"
                  className="text-left block text-sm font-medium leading-6 text-gray-800 dark:text-gray-200"
                >
                  Email address:
                </label>
                <div>
