...
const MainTopics = () => {
  return (
    <div className="bg-[#114b5f] h-[180vh] inlin-flex justify-center relative overflow-hidden">
      ...
      <div className="mt-[1rem] grid grid-cols-4 gap-5 mx-28  ">
        <div className="col-span-1 bg-white  h-[26rem] w-[100%] rounded-3xl mt-8 relative overflow-hidden ">
          ...
          <div className="group ">
            <div
              className="group-hover:animate-in group-hover:slide-in-from-bottom-10 group-hover:duration-1000 
            animate-out slide-out-to-top duration-1000"
            >
              <div
                className="bg-white/50 w-[100%] hidden group-hover:block group-hover:absolute -mt-[17rem]
                       h-[18rem] animate-out duration-1000  "
              >
